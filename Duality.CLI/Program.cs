...
namespace Duality.CLI
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                switch (command)
                {
                    ...
                    case "dev":
                    case "serve":
                        Console.WriteLine("Starting Duality Dev Server...");
                        RunDotnet("watch run");
                        break;
                    case "help":
                    default:
        ...
        {
            Console.WriteLine("Duality CLI Tool");
            Console.WriteLine("  dlty new [name]               - Create a new project");
            Console.WriteLine("  dlty g component [name]       - Generate a component");
            Console.WriteLine("  dlty g page [name]            - Generate a page");
            Console.WriteLine("  dlty dev                      - Run dev server (dotnet watch)");
            Console.WriteLine("  dlty build                    - Build project");
        }
        ...
        static void CopyDirectory(string sourceDir, string destDir, string projectName)
        {
            ...
            foreach (var file in Directory.GetFiles(sourceDir))
            {
                ...
                // It references ../Duality.Runtime. We should keep that for this repo.
